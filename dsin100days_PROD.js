...
export default function() {
  ...
  group('v1 Refactored Jupyter Hub load testing', function() {
    ...
    group('login ', function() {
      let res = http.get('https://dsin100days.refactored.ai//hub/login');
      ...
      if (res.body.includes('Server not running')) {
        ...
        server_stopped = true;
        sleep(30);
        let res2 = http.get("https://dsin100days.refactored.ai/hub/spawn/" + user.username + "?next=%2Fhub%2Fuser%2F" + user.username + "%2Fnotebooks%2Fdsin100days%2Fcontent%2F02-Python_for_Data_Scientists%2F03-Data_Structures_in_python%2F01-Basic_data_types_and_operators.ipynb");
